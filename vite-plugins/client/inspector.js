...
//#region ../../node_modules/.pnpm/scheduler@0.27.0/node_modules/scheduler/cjs/scheduler.production.js
	var require_scheduler_production = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/scheduler@0.27.0/node_modules/scheduler/cjs/scheduler.production.js": ((exports) => {
...
//#region ../../node_modules/.pnpm/react-dom@19.2.0_react@19.2.0/node_modules/react-dom/cjs/react-dom.production.js
	var require_react_dom_production = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/react-dom@19.2.0_react@19.2.0/node_modules/react-dom/cjs/react-dom.production.js": ((exports) => {
		...
		var ReactSharedInternals$1 = React$6.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
...
//#endregion
//#region ../../node_modules/.pnpm/react-dom@19.2.0_react@19.2.0/node_modules/react-dom/cjs/react-dom-client.production.js
	var require_react_dom_client_production = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/react-dom@19.2.0_react@19.2.0/node_modules/react-dom/cjs/react-dom-client.production.js": ((exports) => {
		var Scheduler = require_scheduler(), React$5 = require_react(), ReactDOM$1 = require_react_dom();
		...
		var isArrayImpl = Array.isArray, ReactSharedInternals = React$5.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, ReactDOMSharedInternals = ReactDOM$1.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, sharedNotPendingObject = {
			pending: !1,
			data: null,
			method: null,
			action: null
		...
		var isomorphicReactPackageVersion$jscomp$inline_1840 = React$5.version;
...
//#endregion
//#region components/Notification.tsx
	var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
	const Notification = ({ message }) => {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "source-inspector-notification",
			children: message
		});
	};

//#endregion
//#region components/FeedbackBubble.tsx
	const FeedbackBubble = ({ sourceInfo, element, onSubmit, onClose }) => {
			...
			if (bubbleRef.current) {
				...
				setTimeout(() => {
					if (bubbleRef.current) {
						...
						if (bubbleRect.right > window.innerWidth - 10) bubbleRef.current.style.left = window.innerWidth - bubbleRect.width - 10 + "px";
					}
				}, 0);
			}
		};
		const handleSubmit = () => {
			if (feedback.trim()) onSubmit(feedback);
			onClose();
		};
...
//#endregion
//#region components/InspectorButton.tsx
	const InspectorButton = import_react.forwardRef(({ isActive, onClick }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		ref,
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
			viewBox: "0 0 24 24",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z" })
		})
	}));
	InspectorButton.displayName = "InspectorButton";

//#endregion
//#region components/Overlays.tsx
	const Overlay = import_react.forwardRef(({ visible }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		ref,
		className: "source-inspector-overlay",
		style: { display: visible ? "block" : "none" }
	}));
	Overlay.displayName = "Overlay";
	const Tooltip = import_react.forwardRef(({ visible }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		ref,
...
//#endregion
//#region hooks/useNotification.ts
	const useNotification = (duration = 2500) => {
		const [notification, setNotification] = (0, import_react.useState)(null);
		return {
			notification,
			showNotif: (0, import_react.useCallback)((message) => {
...
//#endregion
//#region hooks/useInspectorHover.ts
	const useInspectorHover = ({ isActive, isWaitingForFeedback, overlayRef, tooltipRef, btnRef }) => {
		(0, import_react.useEffect)(() => {
			if (!isActive || isWaitingForFeedback) return;
			const handleMouseMove = (e) => {
				const target = e.target;
				if (target === btnRef.current || target === overlayRef.current || target === tooltipRef.current) return;
...
//#endregion
//#region sourceDetector.ts
	const getSourceInfo = (element) => {
		let current = element;
		const maxDepth = 20;
		let depth = 0;
		while (current && depth < maxDepth) {
			const fiberKey = Object.keys(current).find((key) => key.startsWith("__reactInternalInstance") || key.startsWith("__reactFiber") || key.startsWith("__react"));
			if (fiberKey) {
				...
				while (fiber) {
					if (fiber.type && typeof fiber.type === "function") {
						...
						if (componentName && componentName !== "Anonymous" && componentName !== "") {
							const metadata = window.__SOURCE_INSPECTOR__ && window.__SOURCE_INSPECTOR__[componentName];
							if (metadata) return {
								...metadata,
								element
							};
...
//#endregion
//#region hooks/useInspectorClick.ts
	const useInspectorClick = ({ isActive, isWaitingForFeedback, onElementInspected, btnRef }) => {
		(0, import_react.useEffect)(() => {
			if (!isActive || isWaitingForFeedback) return;
			const handleClick = (e) => {
				...
				e.preventDefault();
				e.stopPropagation();
				onElementInspected(getSourceInfo(e.target), e.target);
			};
...
//#region inspector.tsx
	const InspectorContainer = () => {
		...
		const [isWaitingForFeedback, setIsWaitingForFeedback] = (0, import_react.useState)(false);
		const [sourceInfo, setSourceInfo] = (0, import_react.useState)(null);
		const [inspectedElement, setInspectedElement] = (0, import_react.useState)(null);
		...
		const toggleInspector = (e) => {
			...
			if (btnRef.current) btnRef.current.classList.toggle("active", newActive);
		...
		const handleFeedbackSubmit = (feedback) => {
			if (sourceInfo) {
				const event = new CustomEvent("element-inspected", { detail: {
					sourceInfo,
					feedback
				} });
		...
		const handleFeedbackClose = () => {
			...
			setIsActive(false);
			if (btnRef.current) btnRef.current.classList.remove("active");
			document.body.style.cursor = "";
			if (overlayRef.current) overlayRef.current.style.display = "none";
			if (tooltipRef.current) tooltipRef.current.style.display = "none";
		};
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(InspectorButton, {
				ref: btnRef,
				isActive,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Overlay, {
				ref: overlayRef,
				visible: isActive && !isWaitingForFeedback
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tooltip, {
				ref: tooltipRef,
				visible: isActive && !isWaitingForFeedback
			}),
			notification && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Notification, { message: notification }),
			showBubble && sourceInfo && inspectedElement && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FeedbackBubble, {
				sourceInfo,
	...
	function initInspector() {
		...
		if (window[INSPECTOR_ID]) return;
		window[INSPECTOR_ID] = true;
		const root$1 = document.createElement("div");
		root$1.id = "source-inspector-root";
		document.body.appendChild(root$1);
		const styles = document.createElement("style");
		styles.textContent = createStyles();
		document.head.appendChild(styles);
		import_client.createRoot(root$1).render(import_react.createElement(InspectorContainer));
	}
	if (typeof document !== "undefined") if (document.readyState === "loading") document.addEventListener("DOMContentLoaded", initInspector);
	else initInspector();
