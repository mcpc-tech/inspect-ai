...
export const InspectorButton = React.forwardRef<HTMLButtonElement, InspectorButtonProps>(
  ({ isActive, onClick, feedbackCount = 0, onMouseEnter, onMouseLeave }, ref) => (
    <button
      ...
      className={cn(
        "fixed bottom-5 right-5 w-10 h-10 rounded-full bg-gray-900 dark:bg-gray-100 border-0 cursor-pointer shadow-lg z-[999998]",
    ...
    >
      <Eye className="w-5 h-5 text-white dark:text-gray-900" />
